...
export const alt = "OverMCP — bid for attention and earn the rank";
      ...
      >
        <div style={{ height: 82, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 34px", borderBottom: "1px solid rgba(242,244,238,.11)" }}>
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <div style={{ marginLeft: 15, display: "flex", flexDirection: "column" }}>
              <span style={{ fontSize: 17, fontWeight: 800, letterSpacing: "-.3px" }}>THE LIVE PRODUCT MARKET</span>
              <span style={{ marginTop: 2, color: "#8f9a92", fontSize: 12 }}>Confirmed bids move the board</span>
            </div>
          </div>
        ...
        <div style={{ flex: 1, display: "flex", padding: "35px 34px 31px" }}>
          <div style={{ width: "57%", display: "flex", flexDirection: "column", justifyContent: "center", paddingRight: 34 }}>
            <div style={{ color: "#72d5a2", fontSize: 13, fontWeight: 800, letterSpacing: "2.4px" }}>A PUBLIC RANKING YOU CAN MOVE</div>
            <div style={{ marginTop: 15, display: "flex", flexDirection: "column", fontSize: 61, lineHeight: .94, fontWeight: 800, letterSpacing: "-3.7px" }}>
              <span>Bid for attention.</span>
              <span style={{ marginTop: 7, color: "#c2e978" }}>Earn the rank.</span>
            </div>
            <div style={{ maxWidth: 600, marginTop: 22, color: "#aab3ad", fontSize: 18, lineHeight: 1.35 }}>
              Put your product on the live leaderboard. Pay once, hold your position, and measure every click.
            </div>
            <div style={{ marginTop: 25, display: "flex", alignItems: "center" }}>
              <div style={{ display: "flex", alignItems: "center", padding: "11px 16px", color: "#0e1512", borderRadius: 10, background: "#c2e978", fontSize: 15, fontWeight: 900 }}>
                ENTER FROM $3 <span style={{ marginLeft: 9, color: "#ff5f4a" }}>→</span>
              </div>
          ...
          <div style={{ width: "43%", display: "flex", flexDirection: "column", padding: 20, border: "1px solid rgba(242,244,238,.12)", borderRadius: 19, background: "#0b100d" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", flexDirection: "column" }}>
                <span style={{ color: "#707a73", fontSize: 10, fontWeight: 800, letterSpacing: "1.8px" }}>TWO WAYS TO WATCH</span>
                <strong style={{ marginTop: 3, fontSize: 20 }}>The market, made visible.</strong>
              </div>
            ...
            <div style={{ marginTop: 19, display: "flex", padding: 4, border: "1px solid rgba(242,244,238,.1)", borderRadius: 10, background: "#121815" }}>
              <div style={{ width: "50%", display: "flex", justifyContent: "center", padding: "9px 6px", color: "#9ba69f", borderRadius: 7, fontSize: 12, fontWeight: 800 }}>MARKET VALUE</div>
              <div style={{ width: "50%", display: "flex", justifyContent: "center", padding: "9px 6px", color: "#0e1512", borderRadius: 7, background: "#c2e978", fontSize: 12, fontWeight: 900 }}>RANK RACE</div>
            </div>
            ...
            <div style={{ marginTop: 13, display: "flex", flexDirection: "column" }}>
              <div style={{ display: "flex", alignItems: "center", padding: "14px 13px", border: "1px solid rgba(242,244,238,.1)", borderRadius: 11, background: "#121815" }}>
                ...
                <div style={{ marginLeft: 12, display: "flex", flexDirection: "column" }}><strong style={{ fontSize: 14 }}>Confirmed value</strong><span style={{ color: "#7f8a82", fontSize: 11 }}>Every bid creates a visible move.</span></div>
              </div>
              <div style={{ marginTop: 9, display: "flex", alignItems: "center", padding: "14px 13px", border: "1px solid rgba(242,244,238,.1)", borderRadius: 11, background: "#121815" }}>
                ...
                <div style={{ marginLeft: 12, display: "flex", flexDirection: "column" }}><strong style={{ fontSize: 14 }}>Position changes</strong><span style={{ color: "#7f8a82", fontSize: 11 }}>Watch products overtake each other.</span></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ height: 49, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 34px", color: "#8f9a92", borderTop: "1px solid rgba(242,244,238,.1)", fontSize: 13 }}>
          ...
          <span>Real bids · Real ranks · Real clicks · No simulated data</span>
        </div>
      </div>
    </div>,
    size,
