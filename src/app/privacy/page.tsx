...
export default function PrivacyPage() {
  return (
    <LegalPage eyebrow="Data practices" title="Privacy policy" updated="August 24, 2026">
      ...
      <p>We store a random browser identifier to measure current and total visitors and help monitor daily race activity. DataFast uses first-party visitor and session identifiers to measure page activity and attribute completed Stripe payments to marketing channels. When someone submits the placement checkout form, DataFast also receives the receipt email and submitted product details as a checkout-intent goal. For outbound-click and race-support abuse controls, one-way values are created from limited network and browser signals. Raw IP addresses are not stored in the click or race-support tables.</p>
